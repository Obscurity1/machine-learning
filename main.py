...
input_dim=4 # колво входных нейронов
out_dim=3 # колво выходных нейронов
h_dim=10 # колво нейронов в скрытом слое

x=[7.9, 3.1, 7.5, 1.8]

# входные тест данные вводятся в след формате: "7,9 3,1 7,5 1,8"
# длина чашелитника 7.9
...
#рандомно вводим значения гиперпарметров:
...
print("Predicted: ", class_name[pred_class])
